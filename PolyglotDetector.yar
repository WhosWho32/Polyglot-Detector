...
rule TRIPLE_POLYGLOT_IMAGE_VIDEO_PDF {
	meta:
		author = "WhosWho"
...
rule TRIPLE_POLYGLOT_IMAGE_VIDEO_ZIP {
	meta:
		author = "WhosWho"
		description = "Image, Video and ZIP Polyglot file detection"
	strings:
		$png = { 89 50 4E 47 0D 0A 1A 0A }
